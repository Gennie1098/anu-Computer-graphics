...
void rst::rasterizer::draw_circle(const Eigen::Vector2i& origin, int radius) {
  ...
  while (x >= y) {
    // plot points for the eight octants of the circle
    set_pixel(Eigen::Vector3f(origin.x() + x, origin.y() + y, 1.0), line_color);
    set_pixel(Eigen::Vector3f(origin.x() - x, origin.y() + y, 1.0), line_color);
    set_pixel(Eigen::Vector3f(origin.x() + x, origin.y() - y, 1.0), line_color);
    set_pixel(Eigen::Vector3f(origin.x() - x, origin.y() - y, 1.0), line_color);
    set_pixel(Eigen::Vector3f(origin.x() + y, origin.y() + x, 1.0), line_color);
    set_pixel(Eigen::Vector3f(origin.x() - y, origin.y() + x, 1.0), line_color);
    set_pixel(Eigen::Vector3f(origin.x() + y, origin.y() - x, 1.0), line_color);
    set_pixel(Eigen::Vector3f(origin.x() - y, origin.y() - x, 1.0), line_color);
